--[[
	Editor: @TristanDevs
	Name: EternityNum2Modified
	Description: A library to handle numbers upto 10↑↑2^1024 (https://googology.fandom.com/wiki/Arrow_notation) with short e notation 1e1k
]]
...
local msd = 1e300 -- max sig digits
...
local SuffixLimit = "9e1E100000004" -- Value when short() doesnt return suffix anymore
